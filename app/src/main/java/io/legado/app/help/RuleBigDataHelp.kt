...
object RuleBigDataHelp {
    ...
    fun putChapterVariable(bookUrl: String, chapterUrl: String, key: String, value: String?) = Unit
    fun getChapterVariable(bookUrl: String, chapterUrl: String, key: String): String? = null
    fun getDanmakuFile(bookUrl: String, chapterUrl: String): String? = null
}
